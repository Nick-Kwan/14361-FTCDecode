...
@Autonomous(name = "Red Joint", group = "Auto")
public class RedJoint extends AutonTemplate {

    // ===== POSES =====
    // Based on Kwan redJoint.java (d32cdda) - mirrored for red alliance
    ...
    private final Pose collectOnePose = new Pose(118.5, 62, Math.toRadians(0));
    private final Pose releaseControlPose = new Pose(116, 65);
    private final Pose releasePose = new Pose(125, 65, Math.toRadians(-90));
    private final Pose shootControlTwoPose = new Pose(94.5, 65);
    private final Pose shootTwoPose = new Pose(87.5, 86.5, Math.toRadians(0));
    private final Pose collectControlTwoPose = new Pose(88, 86);
    private final Pose collectTwoPose = new Pose(117, 86, Math.toRadians(0));
    private final Pose shootControlThreePose = new Pose(95, 89);
    private final Pose shootThreePose = new Pose(90, 89, Math.toRadians(0));
    private final Pose parkPose = new Pose(120, 89, Math.toRadians(0));
