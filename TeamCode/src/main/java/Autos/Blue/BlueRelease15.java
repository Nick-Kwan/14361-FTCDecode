...
@Autonomous(name = "Blue 15 Release", group = "Blue")
public class BlueRelease15 extends AutonTemplate {
    ...
    private final Pose releasePose = new Pose(21, 59, Math.toRadians(180));
    private final Pose releaseControlPose = new Pose(38, 59, Math.toRadians(180));
    private final Pose collectReleasePose = new Pose(16, 53, Math.toRadians(170));
//    private final Pose collectReleaseControlPose = new Pose(16, 54, Math.toRadians(90));
    ...
    private final Pose shootFivePose = new Pose(59.7, 105.3, Math.toRadians(180));
    ...
    protected void buildPaths() {
        ...
        collectRelease = follower.pathBuilder()
                ...
                .addParametricCallback(0.75, () -> spindexer.setPoseOne())
                .build();
